...
public class TrendChart extends JPanel {
	...
	public TrendChart() {
		...
		comboBox_3.setUI(new BasicButtonUI() {
			...
			public void paint(Graphics g, JComponent c) {
				g.drawImage(new ImageIcon(TrendChart.class.getResource("/images/mainJFrame/xialaanniu.png")).getImage(),
		...
		dChartPanel.setBounds(10, 77, 870, 420);
		add(dChartPanel);

		label_2 = new JLabel();
		label_2.setForeground(Color.RED);
		label_2.setFont(new Font("微软雅黑", Font.BOLD, 14));
		label_2.setBounds(40, 44, 478, 18);
		add(label_2);

		label_1 = new JLabel(Config.heziQQqun);
		...
		label_1.setBounds(520, 44, 182, 18);
		add(label_1);

		if (!Config.hezuoQQqun.equals(" ")) {
			label_3 = new JLabel(Config.hezuoQQqun);
			...
			label_3.setBounds(710, 44, 187, 18);
			add(label_3);
		}
	...
	public ChartPanel createJFreeChart() {
		...
		plot.setBackgroundImage(
				new ImageIcon(TrendChart.class.getResource("/images/mainJFrame/watermark.png")).getImage());
